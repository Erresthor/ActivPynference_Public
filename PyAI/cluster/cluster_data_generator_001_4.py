...
from pyai.models_neurofeedback.article_1_simulations.climb_stairs_flat_priors import nf_model_imp3,evaluate_container
...
if __name__=="__main__":
    ...
    model = nf_model_imp3(model_name,save_path,prop_poubelle = prop_poubelle,
