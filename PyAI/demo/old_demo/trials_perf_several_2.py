...
if __name__=="__main__":
    ...
    state_error_mean = 1.0-sliding_window_mean(error_states,smooth_window)
    behaviour_error_mean = 1.0-sliding_window_mean(error_behaviour,smooth_window)
    error_obs_mean = 1.0-sliding_window_mean(error_observations,smooth_window)

    state_error_mean_ok = 1.0-sliding_window_mean(error_states_ok,smooth_window)
    behaviour_error_mean_ok = 1.0-sliding_window_mean(error_behaviour_ok,smooth_window)
    error_obs_mean_ok = 1.0-sliding_window_mean(error_observations_ok,smooth_window)

    state_error_mean_imp = 1.0-sliding_window_mean(error_states_imp,smooth_window)
    behaviour_error_mean_imp = 1.0-sliding_window_mean(error_behaviour_imp,smooth_window)
    error_obs_mean_imp = 1.0-sliding_window_mean(error_observations_imp,smooth_window)

    state_error_mean_sham = 1.0-sliding_window_mean(error_states_sham,smooth_window)
    behaviour_error_mean_sham = 1.0-sliding_window_mean(error_behaviour_sham,smooth_window)
    error_obs_mean_sham = 1.0-sliding_window_mean(error_observations_sham,smooth_window)
