...
class mdp_layer :
    ...
    def copy(self,keep_u = False):
        ...
        copied_lay.name = self.name + '_copy'
        ...
        copied_lay.state_u = flexible_copy(self.state_u) # State dependent allowable actions

        copied_lay.options = self.options
        copied_lay.parameters = self.parameters
