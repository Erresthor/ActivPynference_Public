...
class layer :
    def __init__(self):
        ...
        self.A = None       # A matrix for the concerned process    
        self.B = None       # B matrix for the concerned process  
        self.C = None       # C matrix for the concerned process  
        self.D = None       # D matrix for the concerned process  
        self.E = None       # E matrix for the concerned process  

        self.inputs = None   #

        self.V = None       # Allowable policies (T-1 x Np x F)
        self.U = None       # Allowable actions (1 x Np x F)

        self.o = None       # IMPOSED Sequence of observed outcomes (input by exp)
        self.s = None       # IMPOSED Sequence of true states (input by exp)
        self.u = None       # IMPOSED Chosen Actions (input by exp)
