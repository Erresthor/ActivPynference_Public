...
from pyai.models_neurofeedback.article_1_simulations.climb_stairs_flat_priors import nf_model_imp4,evaluate_container
...
def generate_a_parameter_list(a_priors,b_priors) :
    ...
    for ka in range(a_priors.shape[0]):
        for kb in range(b_priors.shape[0]):
            modelchar = [True,a_priors[ka],1,True,b_priors[kb],10,True,MemoryDecayType.NO_MEMORY_DECAY,2000]
...
if __name__=="__main__":
    ...
    model = nf_model_imp4(model_name,save_path,prop_poubelle = prop_poubelle,
