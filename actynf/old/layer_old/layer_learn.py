...
# def b_learning(model_b,from_qs,to_qs,action_selected,
#                 mem_dec_type = MemoryDecayType.NO_MEMORY_DECAY,t05 = 100):
#     Nf = len(model_b)

#     action_probability_density = model_b[0][:,:,action_selected]
