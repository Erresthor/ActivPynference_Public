...
def nf_model(modelname,savepath,prop_poubelle = 0.0,
                        ...
                        perfect_a = False,perfect_b=False,verbose = False):
    ...
    *ratio* describes a preferential prior. If ratio > 1, the agent will have a positive prior regarding a certain dynamic
    ...
    A_ = [normalize(prior_a_strength*generate_normal_dist_along_matrix(a_[0],prior_A_sigma)+1)]
    ...
    nf_model.a = a_
    if (perfect_a):
        nf_model.A = a_ # The observation matrix is perfect
